          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack  data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000"
                ...
                <Tooltip hasArrow label="9770525851"  bg="#202124" >
                  <IconButton
                    aria-label="phone"
                    variant="ghost"
                    size="lg"
                ...
                <Tooltip hasArrow label="https://github.com/iesparag" bg="#202124" >
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Tooltip hasArrow label="https://www.linkedin.com/in/iesparag/"  bg="#202124" >
