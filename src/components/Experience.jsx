...
import { BrainerHub_ProjectDetail, ClientManagementDetails } from "../StaticData";
...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      <Box>
      <Box mb="10px">
        <Text color="#fb982f" fontSize="24px">BrainerHub Solutions, Ahmedabad</Text>
        <Text fontSize="20px">April 2023 - Present</Text>
        <Text fontSize="24px">Full Stack Developer</Text>
      </Box>
      <Flex  maxWidth="95%" justifyContent="space-between" gap="5% !important" display={{base:"block",md:"block",lg:"flex"}}  >
       <Box w={"100%"}  mb={{base:"5%" ,lg:"auto"}}>
           <Text  color="#fb982f"  fontSize="20px">Development Responsibilities:</Text>
           <Responsibilites items={BrainerHub_ProjectDetail}/>
       </Box>
       <Box w={"100%"} >

           <Text  color="#fb982f"  fontSize="20px">Client Management Responsibilities:</Text>
