import { Box, Heading ,Grid, Text, Button, Flex, Image} from '@chakra-ui/react'
...
const Projects = () => {
  return (
    <Box id="projects" paddingTop={{base:"70px",sm:"70px",md:"100px",lg:"100px"}} >
        ...
        {/* below content */}
       <Box m="auto" w="auto" justifyContent="center"
       data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="1500"  >
        <Grid display="grid"  gridTemplateColumns={{base:"1fr",md:"1fr 1fr",lg:"1fr 1fr 1fr"}} flex-wrap="wrap"    justifyContent="space-evenly" rowGap={10}  >
              {/* 1 */}
              <Box   className="card">
              ...
              <Box  className="card" >
                ...
                <img src="https://i0.wp.com/ketto.blog/wp-content/uploads/2022/12/Is-crowdfunding-still-popular_-Which-crowdfunding-site-is-the-best.png?fit=1024%2C576&ssl=1" alt="ketto" / >
                <Box className="card-desc" p="10px">
