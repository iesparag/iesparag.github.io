            ...
            >
                ...
                >
                    ...
                    <Box className="card">
                        ...
                        <Box className="card-desc" p="10px">
                            <p style={{ height: "80px", marginBottom: "10px" }}>
                                Tech World is a E-commerce website that is used
                                to sell all type of Electronic Products.
                            </p>
                    ...
                    <Box className="card">
                        ...
                        />
                        <Box className="card-desc" p="10px">
                            <p style={{ height: "80px" }} mb="10px">
                                KFC is a fast food brand specializing in
                                chicken.deliver more than 700 food Item{" "}
                            </p>
                            <Heading size="md" margin="10px auto" opacity=".5">
                                Tech Stack
                            </Heading>
                    ...
                    <Box className="card">
                        ...
                        <Box className="card-desc" p="10px">
                            <p style={{ height: "80px", marginBottom: "10px" }}>
                                Ketto is an Online Crowdfunding Platform and
                                Website in India.
                            </p>
                            <Heading size="md" margin="10px auto" opacity=".5">
                                Tech Stack
                    ...
                    <Box className="card">
                        ...
                        <Box className="card-desc" p="10px">
                            <p style={{ height: "80px", marginBottom: "10px" }}>
                                Rentomojo is an online rental solution for all
                                the furnishing needs.
                            </p>
                            <Heading size="md" margin="10px auto" opacity=".5">
                                Tech Stack
                            </Heading>
